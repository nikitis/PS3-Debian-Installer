...
cd /usr/src
git clone --depth 1 git://git.gitbrew.org/ps3/ps3linux/linux-2.6.git || git clone --depth 1 git://storm.gitbrew.org/ps3/ps3linux/linux-2.6.git || git clone --depth 1 git://foxbrew.org/ps3/ps3linux/linux-2.6.git
